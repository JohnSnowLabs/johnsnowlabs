...
assertion = AssertionDLModel.pretrained("assertion_oncology_problem", "en", "clinical/models") \
...
val clinical_assertion = AssertionDLModel.pretrained("assertion_oncology_problem","en","clinical/models")
