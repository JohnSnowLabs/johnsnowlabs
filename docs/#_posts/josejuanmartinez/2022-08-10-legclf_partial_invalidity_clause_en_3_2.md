---
layout: model
title: Legal Partial invalidity Clause Binary Classifier
author: John Snow Labs
name: legclf_partial_invalidity_clause
date: 2022-08-10
...
`other`, `partial-invalidity`

{:.btn-box}
[Live Demo](https://demo.johnsnowlabs.com/finance/CLASSIFY_LEGAL_CLAUSES/){:.button.button-orange}
<button class="button button-orange" disabled>Open in Colab</button>
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_partial_invalidity_clause_en_1.0.0_3.2_1660122811266.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_partial_invalidity_clause_en_1.0.0_3.2_1660122811266.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_partial_invalidity_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_partial_invalidity_clause|
...
partial-invalidity       1.00      0.98      0.99        44
          accuracy          -         -      0.99       170
