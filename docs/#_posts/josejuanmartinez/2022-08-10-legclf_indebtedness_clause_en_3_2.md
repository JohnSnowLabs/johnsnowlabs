---
layout: model
title: Legal Indebtedness Clause Binary Classifier
author: John Snow Labs
name: legclf_indebtedness_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_indebtedness_clause_en_1.0.0_3.2_1660123601510.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_indebtedness_clause_en_1.0.0_3.2_1660123601510.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_indebtedness_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_indebtedness_clause|
...
indebtedness       0.95      0.88      0.91        24
       other       0.96      0.98      0.97        66
    accuracy          -         -      0.96        90
