---
layout: model
title: Legal Contracts Clause Binary Classifier
author: John Snow Labs
name: legclf_contracts_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_contracts_clause_en_1.0.0_3.2_1660123359175.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_contracts_clause_en_1.0.0_3.2_1660123359175.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_contracts_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_contracts_clause|
...
```bash
   ...
   contracts       0.87      0.77      0.82        35
       other       0.85      0.92      0.88        50
    accuracy          -         -      0.86        85
