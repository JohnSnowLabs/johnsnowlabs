---
layout: model
title: Legal Erisa Clause Binary Classifier
author: John Snow Labs
name: legclf_erisa_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_erisa_clause_en_1.0.0_3.2_1660123496220.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_erisa_clause_en_1.0.0_3.2_1660123496220.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_erisa_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_erisa_clause|
...
```bash
       ...
       erisa       0.95      1.00      0.98        21
       other       1.00      0.98      0.99        64
    accuracy          -         -      0.99        85
