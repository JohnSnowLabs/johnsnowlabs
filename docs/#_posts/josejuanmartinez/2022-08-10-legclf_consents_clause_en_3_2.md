---
layout: model
title: Legal Consents Clause Binary Classifier
author: John Snow Labs
name: legclf_consents_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_consents_clause_en_1.0.0_3.2_1660123344303.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_consents_clause_en_1.0.0_3.2_1660123344303.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_consents_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_consents_clause|
...
```bash
    ...
    consents       0.92      0.94      0.93        90
       other       0.97      0.96      0.97       188
    accuracy          -         -      0.96       278
