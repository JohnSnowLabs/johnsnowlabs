---
layout: model
title: Legal In witness whereof Clause Binary Classifier
author: John Snow Labs
name: legclf_in_witness_whereof_clause
date: 2022-08-10
...
`other`, `in-witness-whereof`

{:.btn-box}
[Live Demo](https://demo.johnsnowlabs.com/finance/CLASSIFY_LEGAL_CLAUSES/){:.button.button-orange}
<button class="button button-orange" disabled>Open in Colab</button>
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_in_witness_whereof_clause_en_1.0.0_3.2_1660122497421.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_in_witness_whereof_clause_en_1.0.0_3.2_1660122497421.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_in_witness_whereof_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_in_witness_whereof_clause|
...
in-witness-whereof       0.91      1.00      0.95        21
             other       1.00      0.97      0.99        69
          accuracy          -         -      0.98        90
