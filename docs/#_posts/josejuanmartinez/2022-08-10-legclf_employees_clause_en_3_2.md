---
layout: model
title: Legal Employees Clause Binary Classifier
author: John Snow Labs
name: legclf_employees_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_employees_clause_en_1.0.0_3.2_1660122396915.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_employees_clause_en_1.0.0_3.2_1660122396915.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_employees_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_employees_clause|
...
```bash
   ...
   employees       0.90      0.94      0.92        80
       other       0.98      0.97      0.98       276
    accuracy          -         -      0.96       356
   macro-avg       0.94      0.95      0.95       356
