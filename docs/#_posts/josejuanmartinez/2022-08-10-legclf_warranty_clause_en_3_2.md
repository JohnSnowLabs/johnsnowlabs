---
layout: model
title: Legal Warranty Clause Binary Classifier
author: John Snow Labs
name: legclf_warranty_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_warranty_clause_en_1.0.0_3.2_1660123201384.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_warranty_clause_en_1.0.0_3.2_1660123201384.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_warranty_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_warranty_clause|
...
```bash
       ...
       other       0.94      0.96      0.95        99
    warranty       0.86      0.81      0.83        31
    accuracy          -         -      0.92       130
