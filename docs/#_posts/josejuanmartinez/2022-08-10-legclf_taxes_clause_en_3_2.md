---
layout: model
title: Legal Taxes Clause Binary Classifier
author: John Snow Labs
name: legclf_taxes_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_taxes_clause_en_1.0.0_3.2_1660124052298.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_taxes_clause_en_1.0.0_3.2_1660124052298.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_taxes_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_taxes_clause|
...
```bash
       ...
       other       0.95      0.97      0.96       115
       taxes       0.90      0.85      0.88        41
    accuracy          -         -      0.94       156
