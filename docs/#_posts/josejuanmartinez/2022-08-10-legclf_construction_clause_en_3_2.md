---
layout: model
title: Legal Construction Clause Binary Classifier
author: John Snow Labs
name: legclf_construction_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_construction_clause_en_1.0.0_3.2_1660123351617.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_construction_clause_en_1.0.0_3.2_1660123351617.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_construction_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_construction_clause|
...
construction       0.88      0.84      0.86        43
       other       0.90      0.93      0.92        70
    accuracy          -         -      0.89       113
