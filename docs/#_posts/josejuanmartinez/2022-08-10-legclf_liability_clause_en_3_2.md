---
layout: model
title: Legal Liability Clause Binary Classifier
author: John Snow Labs
name: legclf_liability_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_liability_clause_en_1.0.0_3.2_1660122616869.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_liability_clause_en_1.0.0_3.2_1660122616869.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_liability_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_liability_clause|
...
```bash
   ...
   liability       0.85      0.74      0.79        31
       other       0.93      0.96      0.94       105
    accuracy          -         -      0.91       136
   macro-avg       0.89      0.85      0.87       136
