---
layout: model
title: Legal Judgments Clause Binary Classifier
author: John Snow Labs
name: legclf_judgments_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_judgments_clause_en_1.0.0_3.2_1660122586859.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_judgments_clause_en_1.0.0_3.2_1660122586859.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_judgments_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_judgments_clause|
...
```bash
   ...
   judgments       1.00      0.91      0.96        35
       other       0.98      1.00      0.99       120
    accuracy          -         -      0.98       155
   macro-avg       0.99      0.96      0.97       155
