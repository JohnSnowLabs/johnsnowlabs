---
layout: model
title: Legal Set off Clause Binary Classifier
author: John Snow Labs
name: legclf_set_off_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_set_off_clause_en_1.0.0_3.2_1660122998732.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_set_off_clause_en_1.0.0_3.2_1660122998732.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_set_off_clause", "en", "legal/models")\
