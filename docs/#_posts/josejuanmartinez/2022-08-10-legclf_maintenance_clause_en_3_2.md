---
layout: model
title: Legal Maintenance Clause Binary Classifier
author: John Snow Labs
name: legclf_maintenance_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_maintenance_clause_en_1.0.0_3.2_1660123713462.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_maintenance_clause_en_1.0.0_3.2_1660123713462.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_maintenance_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_maintenance_clause|
...
```bash
 ...
 maintenance       0.93      0.91      0.92        95
       other       0.96      0.97      0.96       201
    accuracy          -         -      0.95       296
