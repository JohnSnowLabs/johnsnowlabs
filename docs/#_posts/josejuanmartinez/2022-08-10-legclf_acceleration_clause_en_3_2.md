---
layout: model
title: Legal Acceleration Clause Binary Classifier
author: John Snow Labs
name: legclf_acceleration_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_acceleration_clause_en_1.0.0_3.2_1660123216364.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_acceleration_clause_en_1.0.0_3.2_1660123216364.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_acceleration_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_acceleration_clause|
...
acceleration       1.00      0.78      0.88        27
       other       0.92      1.00      0.96        65
    accuracy          -         -      0.93        92
   macro-avg       0.96      0.89      0.92        92
