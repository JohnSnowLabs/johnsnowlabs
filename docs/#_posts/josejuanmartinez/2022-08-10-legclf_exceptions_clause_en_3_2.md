...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_exceptions_clause_en_1.0.0_3.2_1660123503661.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_exceptions_clause_en_1.0.0_3.2_1660123503661.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_exceptions_clause", "en", "legal/models")\
...
```bash
  ...
  exceptions       0.88      0.94      0.91        32
       other       0.97      0.95      0.96        79
    accuracy          -         -      0.95       111
   macro-avg       0.93      0.94      0.94       111
