---
layout: model
title: Legal Public announcements Clause Binary Classifier
author: John Snow Labs
name: legclf_public_announcements_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_public_announcements_clause_en_1.0.0_3.2_1660122864114.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_public_announcements_clause_en_1.0.0_3.2_1660122864114.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_public_announcements_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_public_announcements_clause|
...
public-announcements       0.97      1.00      0.99        36
            accuracy          -         -      0.99       122
