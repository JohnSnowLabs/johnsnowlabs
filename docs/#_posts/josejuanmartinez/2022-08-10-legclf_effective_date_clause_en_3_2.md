---
layout: model
title: Legal Effective date Clause Binary Classifier
author: John Snow Labs
name: legclf_effective_date_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_effective_date_clause_en_1.0.0_3.2_1660123458833.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_effective_date_clause_en_1.0.0_3.2_1660123458833.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_effective_date_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_effective_date_clause|
...
effective-date       0.97      0.85      0.91        46
         other       0.93      0.99      0.96        94
      accuracy          -         -      0.94       140
