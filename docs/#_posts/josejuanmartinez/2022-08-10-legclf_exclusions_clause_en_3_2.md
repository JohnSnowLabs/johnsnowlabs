---
layout: model
title: Legal Exclusions Clause Binary Classifier
author: John Snow Labs
name: legclf_exclusions_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_exclusions_clause_en_1.0.0_3.2_1660123511441.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_exclusions_clause_en_1.0.0_3.2_1660123511441.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_exclusions_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_exclusions_clause|
...
```bash
  ...
  exclusions       0.97      0.91      0.94        43
       other       0.95      0.99      0.97        70
    accuracy          -         -      0.96       113
