...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_remedies_clause_en_1.0.0_3.2_1660123931699.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_remedies_clause_en_1.0.0_3.2_1660123931699.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_remedies_clause", "en", "legal/models")\
...
```bash
       ...
       other       0.95      0.96      0.96        56
    remedies       0.92      0.88      0.90        26
    accuracy          -         -      0.94        82
