---
layout: model
title: Legal Adjustments Clause Binary Classifier
author: John Snow Labs
name: legclf_adjustments_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_adjustments_clause_en_1.0.0_3.2_1660123224069.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_adjustments_clause_en_1.0.0_3.2_1660123224069.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_adjustments_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_adjustments_clause|
...
```bash
 ...
 adjustments       0.92      0.89      0.91        27
       other       0.96      0.97      0.96        69
    accuracy          -         -      0.95        96
