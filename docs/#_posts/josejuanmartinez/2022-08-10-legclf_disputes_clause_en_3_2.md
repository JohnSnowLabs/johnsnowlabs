---
layout: model
title: Legal Disputes Clause Binary Classifier
author: John Snow Labs
name: legclf_disputes_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_disputes_clause_en_1.0.0_3.2_1660122366920.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_disputes_clause_en_1.0.0_3.2_1660122366920.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_disputes_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_disputes_clause|
...
```bash
    ...
    disputes       0.96      0.77      0.86        31
       other       0.93      0.99      0.96        99
    accuracy          -         -      0.94       130
   macro-avg       0.95      0.88      0.91       130
