---
layout: model
title: Legal Rent Clause Binary Classifier
author: John Snow Labs
name: legclf_rent_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_rent_clause_en_1.0.0_3.2_1660122938773.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_rent_clause_en_1.0.0_3.2_1660122938773.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_rent_clause", "en", "legal/models")\
...
```bash
       ...
       other       0.97      0.96      0.96        95
        rent       0.88      0.91      0.90        33
    accuracy          -         -      0.95       128
