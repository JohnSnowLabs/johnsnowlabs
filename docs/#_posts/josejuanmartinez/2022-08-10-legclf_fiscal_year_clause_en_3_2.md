---
layout: model
title: Legal Fiscal year Clause Binary Classifier
author: John Snow Labs
name: legclf_fiscal_year_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_fiscal_year_clause_en_1.0.0_3.2_1660123548661.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_fiscal_year_clause_en_1.0.0_3.2_1660123548661.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_fiscal_year_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_fiscal_year_clause|
...
```bash
 ...
 fiscal-year       1.00      0.96      0.98        45
       other       0.98      1.00      0.99        91
    accuracy          -         -      0.99       136
