---
layout: model
title: Legal Term and termination Clause Binary Classifier
author: John Snow Labs
name: legclf_term_and_termination_clause
date: 2022-08-10
...
`other`, `term-and-termination`

{:.btn-box}
[Live Demo](https://demo.johnsnowlabs.com/finance/CLASSIFY_LEGAL_CLAUSES/){:.button.button-orange}
<button class="button button-orange" disabled>Open in Colab</button>
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_term_and_termination_clause_en_1.0.0_3.2_1660123073091.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_term_and_termination_clause_en_1.0.0_3.2_1660123073091.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_term_and_termination_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_term_and_termination_clause|
...
```bash
               ...
               other       0.97      0.97      0.97        95
term-and-termination       0.93      0.93      0.93        40
            accuracy          -         -      0.96       135
