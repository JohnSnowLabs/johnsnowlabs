---
layout: model
title: Legal Transactions with affiliates Clause Binary Classifier
author: John Snow Labs
name: legclf_transactions_with_affiliates_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_transactions_with_affiliates_clause_en_1.0.0_3.2_1660123125455.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_transactions_with_affiliates_clause_en_1.0.0_3.2_1660123125455.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_transactions_with_affiliates_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_transactions_with_affiliates_clause|
...
```bash
                       ...
                       other       0.97      0.98      0.97        86
transactions-with-affiliates       0.92      0.88      0.90        26
                    accuracy          -         -      0.96       112
