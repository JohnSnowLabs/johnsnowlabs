---
layout: model
title: Legal Introduction Clause Binary Classifier
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_introduction_clause_en_1.0.0_3.2_1660122579442.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_introduction_clause_en_1.0.0_3.2_1660122579442.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_introduction_clause", "en", "legal/models")\
...
introduction       0.82      0.84      0.83        32
       other       0.94      0.93      0.94        90
    accuracy          -         -      0.91       122
