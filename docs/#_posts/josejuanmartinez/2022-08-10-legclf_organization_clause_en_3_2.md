---
layout: model
title: Legal Organization Clause Binary Classifier
author: John Snow Labs
name: legclf_organization_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_organization_clause_en_1.0.0_3.2_1660123788612.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_organization_clause_en_1.0.0_3.2_1660123788612.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_organization_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_organization_clause|
...
organization       0.99      0.91      0.95       100
       other       0.96      1.00      0.98       207
    accuracy          -         -      0.97       307
   macro-avg       0.97      0.95      0.96       307
