---
layout: model
title: Legal Restrictions Clause Binary Classifier
author: John Snow Labs
name: legclf_restrictions_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_restrictions_clause_en_1.0.0_3.2_1660123954238.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_restrictions_clause_en_1.0.0_3.2_1660123954238.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_restrictions_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_restrictions_clause|
...
```bash
       ...
       other       0.81      0.97      0.88        61
restrictions       0.91      0.60      0.72        35
    accuracy          -         -      0.83        96
   macro-avg       0.86      0.78      0.80        96
