---
layout: model
title: Legal Termination of employment Clause Binary Classifier
author: John Snow Labs
name: legclf_termination_of_employment_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_termination_of_employment_clause_en_1.0.0_3.2_1660124066973.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_termination_of_employment_clause_en_1.0.0_3.2_1660124066973.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_termination_of_employment_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_termination_of_employment_clause|
...
```bash
                    ...
                    other       0.97      1.00      0.99        72
termination-of-employment       1.00      0.95      0.98        42
                 accuracy          -         -      0.98       114
