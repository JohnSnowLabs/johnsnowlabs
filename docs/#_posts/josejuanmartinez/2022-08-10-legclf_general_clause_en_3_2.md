---
layout: model
title: Legal General Clause Binary Classifier
author: John Snow Labs
name: legclf_general_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_general_clause_en_1.0.0_3.2_1660123556610.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_general_clause_en_1.0.0_3.2_1660123556610.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_general_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_general_clause|
