---
layout: model
title: Legal Purpose Clause Binary Classifier
author: John Snow Labs
name: legclf_purpose_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_purpose_clause_en_1.0.0_3.2_1660123878905.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_purpose_clause_en_1.0.0_3.2_1660123878905.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_purpose_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_purpose_clause|
...
```bash
       ...
       other       0.94      0.98      0.96        93
     purpose       0.94      0.84      0.89        37
    accuracy          -         -      0.94       130
