---
layout: model
title: Legal Insolvency Clause Binary Classifier
author: John Snow Labs
name: legclf_insolvency_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_insolvency_clause_en_1.0.0_3.2_1660122549928.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_insolvency_clause_en_1.0.0_3.2_1660122549928.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_insolvency_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_insolvency_clause|
...
```bash
  ...
  insolvency       0.98      0.98      0.98        43
       other       0.99      0.99      0.99       101
    accuracy          -         -      0.99       144
