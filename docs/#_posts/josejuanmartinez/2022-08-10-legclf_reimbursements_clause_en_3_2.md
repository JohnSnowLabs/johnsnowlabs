---
layout: model
title: Legal Reimbursements Clause Binary Classifier
author: John Snow Labs
name: legclf_reimbursements_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_reimbursements_clause_en_1.0.0_3.2_1660123924164.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_reimbursements_clause_en_1.0.0_3.2_1660123924164.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_reimbursements_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_reimbursements_clause|
...
```bash
         ...
         other       0.96      0.97      0.96       132
reimbursements       0.93      0.90      0.91        58
      accuracy          -         -      0.95       190
