---
layout: model
title: Legal Effectiveness Clause Binary Classifier
author: John Snow Labs
name: legclf_effectiveness_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_effectiveness_clause_en_1.0.0_3.2_1660123466311.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_effectiveness_clause_en_1.0.0_3.2_1660123466311.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_effectiveness_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_effectiveness_clause|
...
effectiveness       0.94      0.86      0.90        37
        other       0.95      0.98      0.96        93
     accuracy          -         -      0.95       130
