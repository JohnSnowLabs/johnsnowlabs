...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_preamble_clause_en_1.0.0_3.2_1660123833867.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_preamble_clause_en_1.0.0_3.2_1660123833867.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_preamble_clause", "en", "legal/models")\
...
```bash
       ...
       other       0.94      0.94      0.94        66
    preamble       0.84      0.84      0.84        25
    accuracy          -         -      0.91        91
