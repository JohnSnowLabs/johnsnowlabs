---
layout: model
title: Legal Stock options Clause Binary Classifier
author: John Snow Labs
name: legclf_stock_options_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_stock_options_clause_en_1.0.0_3.2_1660123043343.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_stock_options_clause_en_1.0.0_3.2_1660123043343.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_stock_options_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_stock_options_clause|
...
```bash
        ...
        other       0.98      0.97      0.97        87
stock-options       0.86      0.90      0.88        21
     accuracy          -         -      0.95       108
