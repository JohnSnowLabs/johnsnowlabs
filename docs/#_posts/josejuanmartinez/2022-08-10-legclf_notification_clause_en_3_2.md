---
layout: model
title: Legal Notification Clause Binary Classifier
author: John Snow Labs
name: legclf_notification_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_notification_clause_en_1.0.0_3.2_1660123773456.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_notification_clause_en_1.0.0_3.2_1660123773456.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_notification_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_notification_clause|
...
notification       0.87      0.91      0.89        90
       other       0.96      0.94      0.95       214
    accuracy          -         -      0.93       304
