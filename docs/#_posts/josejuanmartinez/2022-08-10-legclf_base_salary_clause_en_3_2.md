---
layout: model
title: Legal Base salary Clause Binary Classifier
author: John Snow Labs
name: legclf_base_salary_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_base_salary_clause_en_1.0.0_3.2_1660122165052.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_base_salary_clause_en_1.0.0_3.2_1660122165052.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_base_salary_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_base_salary_clause|
