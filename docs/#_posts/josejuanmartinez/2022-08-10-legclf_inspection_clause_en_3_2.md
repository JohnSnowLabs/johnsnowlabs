---
layout: model
title: Legal Inspection Clause Binary Classifier
author: John Snow Labs
name: legclf_inspection_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_inspection_clause_en_1.0.0_3.2_1660123616387.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_inspection_clause_en_1.0.0_3.2_1660123616387.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_inspection_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_inspection_clause|
...
```bash
  ...
  inspection       0.89      0.89      0.89        27
       other       0.95      0.95      0.95        64
    accuracy          -         -      0.93        91
