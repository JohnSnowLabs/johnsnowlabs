---
layout: model
title: Legal Indemnification Clause Binary Classifier
author: John Snow Labs
name: legclf_indemnification_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_indemnification_clause_en_1.0.0_3.2_1660123608974.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_indemnification_clause_en_1.0.0_3.2_1660123608974.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_indemnification_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_indemnification_clause|
...
indemnification       0.94      0.81      0.87        37
          other       0.91      0.97      0.94        71
       accuracy          -         -      0.92       108
      macro-avg       0.92      0.89      0.90       108
