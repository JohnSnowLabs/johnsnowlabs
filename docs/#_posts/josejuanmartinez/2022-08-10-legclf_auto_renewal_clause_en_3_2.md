---
layout: model
title: Legal Auto renewal Clause Binary Classifier
author: John Snow Labs
name: legclf_auto_renewal_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_auto_renewal_clause_en_1.0.0_3.2_1660122142731.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_auto_renewal_clause_en_1.0.0_3.2_1660122142731.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_auto_renewal_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_auto_renewal_clause|
...
auto_renewal       0.88      0.91      0.89        32
       other       0.97      0.96      0.97       104
    accuracy          -         -      0.95       136
