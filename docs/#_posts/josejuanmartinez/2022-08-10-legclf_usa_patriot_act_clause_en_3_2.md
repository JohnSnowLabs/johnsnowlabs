---
layout: model
title: Legal Usa patriot act Clause Binary Classifier
author: John Snow Labs
name: legclf_usa_patriot_act_clause
date: 2022-08-10
...
`other`, `usa-patriot-act`

{:.btn-box}
[Live Demo](https://demo.johnsnowlabs.com/finance/CLASSIFY_LEGAL_CLAUSES/){:.button.button-orange}
<button class="button button-orange" disabled>Open in Colab</button>
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_usa_patriot_act_clause_en_1.0.0_3.2_1660123155724.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_usa_patriot_act_clause_en_1.0.0_3.2_1660123155724.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_usa_patriot_act_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_usa_patriot_act_clause|
