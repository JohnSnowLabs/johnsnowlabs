---
layout: model
title: Legal Holidays Clause Binary Classifier
author: John Snow Labs
name: legclf_holidays_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_holidays_clause_en_1.0.0_3.2_1660123586412.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_holidays_clause_en_1.0.0_3.2_1660123586412.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_holidays_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_holidays_clause|
...
```bash
    ...
    holidays       0.98      0.94      0.96        49
       other       0.96      0.99      0.97        68
    accuracy          -         -      0.97       117
