---
layout: model
title: Legal Increased costs Clause Binary Classifier
author: John Snow Labs
name: legclf_increased_costs_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_increased_costs_clause_en_1.0.0_3.2_1660122505120.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_increased_costs_clause_en_1.0.0_3.2_1660122505120.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_increased_costs_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_increased_costs_clause|
...
increased-costs       1.00      0.94      0.97        36
          other       0.98      1.00      0.99       100
       accuracy          -         -      0.99       136
