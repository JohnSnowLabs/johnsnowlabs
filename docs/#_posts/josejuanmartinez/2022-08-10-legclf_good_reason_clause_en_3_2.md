---
layout: model
title: Legal Good reason Clause Binary Classifier
author: John Snow Labs
name: legclf_good_reason_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_good_reason_clause_en_1.0.0_3.2_1660123563997.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_good_reason_clause_en_1.0.0_3.2_1660123563997.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_good_reason_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_good_reason_clause|
...
```bash
 ...
 good-reason       0.97      0.92      0.94        36
       other       0.96      0.99      0.98        82
    accuracy          -         -      0.97       118
   macro-avg       0.97      0.95      0.96       118
