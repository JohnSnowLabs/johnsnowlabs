---
layout: model
title: Legal Publicity Clause Binary Classifier
author: John Snow Labs
name: legclf_publicity_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_publicity_clause_en_1.0.0_3.2_1660122871432.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_publicity_clause_en_1.0.0_3.2_1660122871432.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_publicity_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_publicity_clause|
...
```bash
       ...
       other       0.94      0.98      0.96        96
   publicity       0.94      0.84      0.89        37
    accuracy          -         -      0.94       133
