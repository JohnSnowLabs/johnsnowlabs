---
layout: model
title: Legal Officers Clause Binary Classifier
author: John Snow Labs
name: legclf_officers_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_officers_clause_en_1.0.0_3.2_1660123780978.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_officers_clause_en_1.0.0_3.2_1660123780978.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_officers_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_officers_clause|
...
```bash
    ...
    officers       0.97      0.94      0.96        35
       other       0.97      0.99      0.98        74
    accuracy          -         -      0.97       109
