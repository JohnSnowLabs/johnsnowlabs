---
layout: model
title: Legal Meetings Clause Binary Classifier
author: John Snow Labs
name: legclf_meetings_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_meetings_clause_en_1.0.0_3.2_1660123728288.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_meetings_clause_en_1.0.0_3.2_1660123728288.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_meetings_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_meetings_clause|
...
```bash
    ...
    meetings       0.96      0.93      0.94        27
       other       0.97      0.99      0.98        75
    accuracy          -         -      0.97       102
