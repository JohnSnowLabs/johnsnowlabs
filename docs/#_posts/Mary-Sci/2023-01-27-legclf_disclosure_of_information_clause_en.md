...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_disclosure_of_information_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_disclosure_of_information_clause|
...
disclosure-of-information       1.00      0.96      0.98        26
