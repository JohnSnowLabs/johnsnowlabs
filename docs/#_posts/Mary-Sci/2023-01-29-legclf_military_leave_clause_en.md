---
layout: model
title: Legal Military Leave Clause Binary Classifier
author: John Snow Labs
name: legclf_military_leave_clause
date: 2023-01-29
tags: [en, legal, classification, military, leave, clauses, military_leave, licensed, tensorflow]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_military_leave_clause_en_1.0.0_3.0_1674994024589.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_military_leave_clause_en_1.0.0_3.0_1674994024589.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_military_leave_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_military_leave_clause|
...
subcontractors       0.95      1.00      0.98        21
      accuracy          -         -      0.98        60
