---
layout: model
title: Legal Termination Clause Binary Classifier
author: John Snow Labs
name: legclf_termination_clause
date: 2023-02-13
tags: [en, legal, classification, termination, licensed, tensorflow]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_termination_clause_en_1.0.0_3.0_1676303921297.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_termination_clause_en_1.0.0_3.0_1676303921297.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_termination_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_termination_clause|
