---
layout: model
title: Legal Principal underwriter Clause Binary Classifier
author: John Snow Labs
name: legclf_principal_underwriter_clause
date: 2022-12-05
tags: [en, legal, principal_underwriter, classification, clauses, licensed]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_principal_underwriter_clause_en_1.0.0_3.0_1670245665002.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_principal_underwriter_clause_en_1.0.0_3.0_1670245665002.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = legal.ClassifierDLModel.pretrained("legclf_principal_underwriter_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_principal_underwriter_clause|
