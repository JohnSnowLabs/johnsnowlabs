...
This pretrained pipeline is built on the top of [ner_posology](https://nlp.johnsnowlabs.com/2020/04/15/ner_posology_en.html) model.
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/ner_posology_pipeline_en_3.4.1_3.0_1647871564965.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/ner_posology_pipeline_en_3.4.1_3.0_1647871564965.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
- NerConverter
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc1MzMyMzE1N119
-->