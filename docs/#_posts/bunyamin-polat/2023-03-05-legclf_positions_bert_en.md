---
layout: model
title: Legal Positions Clause Binary Classifier (LEDGAR)
author: John Snow Labs
name: legclf_positions_bert
date: 2023-03-05
tags: [en, legal, classification, clauses, positions, licensed, tensorflow]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_positions_bert_en_1.0.0_3.0_1678050569234.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_positions_bert_en_1.0.0_3.0_1678050569234.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_positions_bert", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_positions_bert|
