---
layout: model
title: Legal Compliance With Laws Clause Binary Classifier (LEDGAR)
author: John Snow Labs
name: legclf_compliance_with_laws_bert
date: 2023-03-05
tags: [en, legal, classification, clauses, compliance_with_laws, licensed, tensorflow]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_compliance_with_laws_bert_en_1.0.0_3.0_1678050642566.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_compliance_with_laws_bert_en_1.0.0_3.0_1678050642566.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
