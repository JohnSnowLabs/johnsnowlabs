---
layout: model
title: Legal Taxes Clause Binary Classifier (LEDGAR)
author: John Snow Labs
name: legclf_taxes_bert
date: 2023-03-05
tags: [en, legal, classification, clauses, taxes, licensed, tensorflow]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_taxes_bert_en_1.0.0_3.0_1678050662883.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_taxes_bert_en_1.0.0_3.0_1678050662883.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_taxes_bert", "en", "legal/models")\
