---
layout: model
title: Legal Benefits Clause Binary Classifier (LEDGAR)
author: John Snow Labs
name: legclf_benefits_bert
date: 2023-03-05
tags: [en, legal, classification, clauses, benefits, licensed, tensorflow]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_benefits_bert_en_1.0.0_3.0_1678050723092.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_benefits_bert_en_1.0.0_3.0_1678050723092.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_benefits_bert", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_benefits_bert|
...
```bash
    ...
    Benefits      0.86   0.94      0.90       47
       Other      0.95   0.90      0.93       70
    accuracy         -      -      0.91      117
