---
layout: model
title: Legal Tax Withholdings Clause Binary Classifier (LEDGAR)
author: John Snow Labs
name: legclf_tax_withholdings_bert
date: 2023-03-05
tags: [en, legal, classification, clauses, tax_withholdings, licensed, tensorflow]
...
`Tax_Withholdings`, `Other`

{:.btn-box}
<button class="button button-orange" disabled>Live Demo</button>
<button class="button button-orange" disabled>Open in Colab</button>
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_tax_withholdings_bert_en_1.0.0_3.0_1678049984586.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_tax_withholdings_bert_en_1.0.0_3.0_1678049984586.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_tax_withholdings_bert", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_tax_withholdings_bert|
...
```bash
           ...
           Other      0.95   0.95      0.95       65
Tax_Withholdings      0.93   0.93      0.93       44
        accuracy         -      -      0.94      109
