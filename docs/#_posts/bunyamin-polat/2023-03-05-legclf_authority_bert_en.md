---
layout: model
title: Legal Authority Clause Binary Classifier (LEDGAR)
author: John Snow Labs
name: legclf_authority_bert
date: 2023-03-05
tags: [en, legal, classification, clauses, authority, licensed, tensorflow]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_authority_bert_en_1.0.0_3.0_1678050593552.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_authority_bert_en_1.0.0_3.0_1678050593552.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_authority_bert", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_authority_bert|
...
```bash
   ...
   Authority      0.93   0.93      0.93       56
       Other      0.95   0.95      0.95       82
    accuracy         -      -      0.94      138
