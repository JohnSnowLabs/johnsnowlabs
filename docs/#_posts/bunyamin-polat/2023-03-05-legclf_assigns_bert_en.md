---
layout: model
title: Legal Assigns Clause Binary Classifier (LEDGAR)
author: John Snow Labs
name: legclf_assigns_bert
date: 2023-03-05
tags: [en, legal, classification, clauses, assigns, licensed, tensorflow]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_assigns_bert_en_1.0.0_3.0_1678050622215.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_assigns_bert_en_1.0.0_3.0_1678050622215.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_assigns_bert", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_assigns_bert|
