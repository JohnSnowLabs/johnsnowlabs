---
layout: model
title: Legal Expenses Clause Binary Classifier (LEDGAR)
author: John Snow Labs
name: legclf_expenses_bert
date: 2023-03-05
tags: [en, legal, classification, clauses, expenses, licensed, tensorflow]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_expenses_bert_en_1.0.0_3.0_1678050658714.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_expenses_bert_en_1.0.0_3.0_1678050658714.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_expenses_bert", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_expenses_bert|
...
```bash
    ...
    Expenses      0.93   0.97      0.95      143
       Other      0.98   0.94      0.96      173
    accuracy         -      -      0.95      316
