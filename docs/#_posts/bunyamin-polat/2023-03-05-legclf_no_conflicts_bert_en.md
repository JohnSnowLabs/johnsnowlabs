---
layout: model
title: Legal No Conflicts Clause Binary Classifier (LEDGAR)
author: John Snow Labs
name: legclf_no_conflicts_bert
date: 2023-03-05
tags: [en, legal, classification, clauses, no_conflicts, licensed, tensorflow]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_no_conflicts_bert_en_1.0.0_3.0_1678050654719.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_no_conflicts_bert_en_1.0.0_3.0_1678050654719.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_no_conflicts_bert", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_no_conflicts_bert|
...
No_Conflicts      0.96   0.98      0.97       84
       Other      0.98   0.97      0.98      118
    accuracy         -      -      0.98      202
