---
layout: model
title: Legal Approvals Clause Binary Classifier (LEDGAR)
author: John Snow Labs
name: legclf_approvals_bert
date: 2023-03-05
tags: [en, legal, classification, clauses, approvals, licensed, tensorflow]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_approvals_bert_en_1.0.0_3.0_1678050666848.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_approvals_bert_en_1.0.0_3.0_1678050666848.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_approvals_bert", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_approvals_bert|
...
```bash
   ...
   Approvals      0.88   0.93      0.90       15
       Other      0.96   0.93      0.95       29
    accuracy         -      -      0.93       44
