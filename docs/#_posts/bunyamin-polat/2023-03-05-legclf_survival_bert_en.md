---
layout: model
title: Legal Survival Clause Binary Classifier (LEDGAR)
author: John Snow Labs
name: legclf_survival_bert
date: 2023-03-05
tags: [en, legal, classification, clauses, survival, licensed, tensorflow]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_survival_bert_en_1.0.0_3.0_1678049964185.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_survival_bert_en_1.0.0_3.0_1678049964185.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_survival_bert", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_survival_bert|
...
```bash
       ...
       Other      0.97   0.99      0.98      206
    Survival      0.98   0.96      0.97      183
    accuracy         -      -      0.97      389
