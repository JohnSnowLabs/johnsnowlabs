---
layout: model
title: Legal Headings Clause Binary Classifier (LEDGAR)
author: John Snow Labs
name: legclf_headings_bert
date: 2023-03-05
tags: [en, legal, classification, clauses, headings, licensed, tensorflow]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_headings_bert_en_1.0.0_3.0_1678050671024.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_headings_bert_en_1.0.0_3.0_1678050671024.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_headings_bert", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_headings_bert|
...
```bash
    ...
    Headings      1.00   0.98      0.99       81
       Other      0.98   1.00      0.99      117
    accuracy         -      -      0.99      198
