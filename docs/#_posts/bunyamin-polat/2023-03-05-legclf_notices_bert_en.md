---
layout: model
title: Legal Notices Clause Binary Classifier (LEDGAR)
author: John Snow Labs
name: legclf_notices_bert
date: 2023-03-05
tags: [en, legal, classification, clauses, notices, licensed, tensorflow]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_notices_bert_en_1.0.0_3.0_1678049992578.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_notices_bert_en_1.0.0_3.0_1678049992578.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_notices_bert", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_notices_bert|
...
```bash
     ...
     Notices      0.98   0.97      0.97      301
       Other      0.97   0.98      0.97      337
    accuracy         -      -      0.97      638
