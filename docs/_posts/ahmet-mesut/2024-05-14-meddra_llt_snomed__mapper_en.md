...
name: meddra_llt_snomed__mapper
date: 2024-05-14
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/meddra_llt_snomed__mapper_en_5.3.2_3.0_1715707153719.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/meddra_llt_snomed__mapper_en_5.3.2_3.0_1715707153719.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
chunkMapper = ChunkMapperModel.load('meddra_llt_snomed__mapper')\
...
val chunkMapper = new ChunkMapperModel.load("model_meddra_to_snomed_mapper")
...
{:.table-model}
|---|---|
|Model Name:|meddra_llt_snomed__mapper|
