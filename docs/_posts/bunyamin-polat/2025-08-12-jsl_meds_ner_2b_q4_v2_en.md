---
layout: model
title: JSL_MedS_NER (2B - q4 - v2)
author: John Snow Labs
name: jsl_meds_ner_2b_q4_v2
date: 2025-08-12
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/jsl_meds_ner_2b_q4_v2_en_6.1.0_3.0_1755005326640.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/jsl_meds_ner_2b_q4_v2_en_6.1.0_3.0_1755005326640.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
medical_llm = MedicalLLM.pretrained("jsl_meds_ner_2b_q4_v2", "en", "clinical/models")\
...
medical_llm = medical.AutoGGUFModel.pretrained("jsl_meds_ner_2b_q4_v2", "en", "clinical/models")\
    .setInputCols("document")\
    .setOutputCol("completions")\
    .setBatchSize(1)\
    .setNPredict(100)\
...
val medical_llm = MedicalLLM.pretrained("jsl_meds_ner_2b_q4_v2", "en", "clinical/models")
    .setInputCols("document")
    .setOutputCol("completions")
    .setBatchSize(1)
    .setNPredict(100)
...
{:.table-model}
|---|---|
|Model Name:|jsl_meds_ner_2b_q4_v2|
