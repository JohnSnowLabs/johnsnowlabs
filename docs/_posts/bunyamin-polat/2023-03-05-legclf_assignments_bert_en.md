---
layout: model
title: Legal Assignments Clause Binary Classifier (LEDGAR)
author: John Snow Labs
name: legclf_assignments_bert
date: 2023-03-05
tags: [en, legal, classification, clauses, assignments, licensed, tensorflow]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_assignments_bert_en_1.0.0_3.0_1678050646575.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_assignments_bert_en_1.0.0_3.0_1678050646575.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_assignments_bert", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_assignments_bert|
...
```bash
 ...
 Assignments      0.93   0.94      0.93      157
       Other      0.95   0.94      0.94      188
    accuracy         -      -      0.94      345
