---
layout: model
title: Legal Publicity Clause Binary Classifier (LEDGAR)
author: John Snow Labs
name: legclf_publicity_bert
date: 2023-03-05
tags: [en, legal, classification, clauses, publicity, licensed, tensorflow]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_publicity_bert_en_1.0.0_3.0_1678050025086.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_publicity_bert_en_1.0.0_3.0_1678050025086.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_publicity_bert", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_publicity_bert|
...
```bash
       ...
       Other      1.00   0.96      0.98       56
   Publicity      0.95   1.00      0.97       38
    accuracy         -      -      0.98       94
