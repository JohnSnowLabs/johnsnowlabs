...
date: 2022-12-07
tags: [en, legal, classification, clauses, rules_and_regulations, licensed, tensorflow]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_rules_and_regulations_clause_en_1.0.0_3.0_1670444814223.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_rules_and_regulations_clause_en_1.0.0_3.0_1670444814223.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_rules_and_regulations_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_rules_and_regulations_clause|
...
```bash
                ...
                other       0.97      1.00      0.99        73
rules-and-regulations       1.00      0.93      0.96        28
             accuracy         -         -       0.98       101
