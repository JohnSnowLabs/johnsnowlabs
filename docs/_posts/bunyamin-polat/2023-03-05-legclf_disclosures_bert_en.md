---
layout: model
title: Legal Disclosures Clause Binary Classifier (LEDGAR)
author: John Snow Labs
name: legclf_disclosures_bert
date: 2023-03-05
tags: [en, legal, classification, clauses, disclosures, licensed, tensorflow]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_disclosures_bert_en_1.0.0_3.0_1678050000589.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_disclosures_bert_en_1.0.0_3.0_1678050000589.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_disclosures_bert", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_disclosures_bert|
...
```bash
 ...
 Disclosures      0.97   0.86      0.91       70
       Other      0.90   0.98      0.94       97
    accuracy         -      -      0.93      167
