---
layout: model
title: Legal Applicable Laws Clause Binary Classifier (LEDGAR)
author: John Snow Labs
name: legclf_applicable_laws_bert
date: 2023-03-05
tags: [en, legal, classification, clauses, applicable_laws, licensed, tensorflow]
...
`Applicable_Laws`, `Other`

{:.btn-box}
<button class="button button-orange" disabled>Live Demo</button>
<button class="button button-orange" disabled>Open in Colab</button>
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_applicable_laws_bert_en_1.0.0_3.0_1678050521046.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_applicable_laws_bert_en_1.0.0_3.0_1678050521046.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_applicable_laws_bert", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_applicable_laws_bert|
...
Applicable_Laws      0.80   1.00      0.89       40
          Other      1.00   0.84      0.91       61
       accuracy         -      -      0.90      101
      macro-avg      0.90   0.92      0.90      101
