---
layout: model
title: Legal Solvency Clause Binary Classifier (LEDGAR)
author: John Snow Labs
name: legclf_solvency_bert
date: 2023-03-05
tags: [en, legal, classification, clauses, solvency, licensed, tensorflow]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_solvency_bert_en_1.0.0_3.0_1678050703009.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_solvency_bert_en_1.0.0_3.0_1678050703009.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_solvency_bert", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_solvency_bert|
...
```bash
       ...
       Other      1.00   0.99      0.99       70
    Solvency      0.98   1.00      0.99       48
    accuracy         -      -      0.99      118
