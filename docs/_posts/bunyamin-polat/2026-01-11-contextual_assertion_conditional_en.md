...
date: 2026-01-11
tags: [conditional, en, assertion, contextual, licensed, clinical]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/contextual_assertion_conditional_en_6.2.2_3.4_1768168057679.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/contextual_assertion_conditional_en_6.2.2_3.4_1768168057679.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
contextual_assertion = ContextualAssertion\
    ...
    .setOutputCol("assertionConditional")

flattener = Flattener()\
    .setInputCols("assertionConditional")\
    .setExplodeSelectedFields({"assertionConditional": ["metadata.ner_chunk as ner_chunk",
                                                      "begin as begin",
                                                      "end as end",
...
val flattener = new Flattener()
    .setInputCols("assertionConditional")
    .setExplodeSelectedFields(Map("assertionConditional" -> Array(
