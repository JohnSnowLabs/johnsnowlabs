---
layout: model
title: Legal Insurances Clause Binary Classifier (LEDGAR)
author: John Snow Labs
name: legclf_insurances_bert
date: 2023-03-05
tags: [en, legal, classification, clauses, insurances, licensed, tensorflow]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_insurances_bert_en_1.0.0_3.0_1678049903507.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_insurances_bert_en_1.0.0_3.0_1678049903507.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_insurances_bert", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_insurances_bert|
...
```bash
  ...
  Insurances      0.97   0.97      0.97      129
       Other      0.98   0.98      0.98      162
    accuracy         -      -      0.97      291
