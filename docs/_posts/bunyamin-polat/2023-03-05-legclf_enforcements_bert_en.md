---
layout: model
title: Legal Enforcements Clause Binary Classifier (LEDGAR)
author: John Snow Labs
name: legclf_enforcements_bert
date: 2023-03-05
tags: [en, legal, classification, clauses, enforcements, licensed, tensorflow]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_enforcements_bert_en_1.0.0_3.0_1678050541165.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_enforcements_bert_en_1.0.0_3.0_1678050541165.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_enforcements_bert", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_enforcements_bert|
...
Enforcements      0.77   0.95      0.85       21
       Other      0.97   0.82      0.89       34
    accuracy         -      -      0.87       55
