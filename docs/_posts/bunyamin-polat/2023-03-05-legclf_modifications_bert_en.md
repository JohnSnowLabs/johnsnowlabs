---
layout: model
title: Legal Modifications Clause Binary Classifier (LEDGAR)
author: John Snow Labs
name: legclf_modifications_bert
date: 2023-03-05
tags: [en, legal, classification, clauses, modifications, licensed, tensorflow]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_modifications_bert_en_1.0.0_3.0_1678050613956.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_modifications_bert_en_1.0.0_3.0_1678050613956.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_modifications_bert", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_modifications_bert|
...
Modifications      0.83   0.89      0.86       27
        Other      0.93   0.88      0.90       43
     accuracy         -      -      0.89       70
