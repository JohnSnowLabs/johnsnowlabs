---
layout: model
title: Legal Use Of Proceeds Clause Binary Classifier (LEDGAR)
author: John Snow Labs
name: legclf_use_of_proceeds_bert
date: 2023-03-05
tags: [en, legal, classification, clauses, use_of_proceeds, licensed, tensorflow]
...
`Use_Of_Proceeds`, `Other`

{:.btn-box}
<button class="button button-orange" disabled>Live Demo</button>
<button class="button button-orange" disabled>Open in Colab</button>
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_use_of_proceeds_bert_en_1.0.0_3.0_1678049873085.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_use_of_proceeds_bert_en_1.0.0_3.0_1678049873085.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_use_of_proceeds_bert", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_use_of_proceeds_bert|
...
```bash
          ...
          Other      0.98   0.98      0.98      132
Use_Of_Proceeds      0.98   0.98      0.98       94
       accuracy         -      -      0.98      226
