---
layout: model
title: Legal Indemnity Clause Binary Classifier (LEDGAR)
author: John Snow Labs
name: legclf_indemnity_bert
date: 2023-03-05
tags: [en, legal, classification, clauses, indemnity, licensed, tensorflow]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_indemnity_bert_en_1.0.0_3.0_1678049927751.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_indemnity_bert_en_1.0.0_3.0_1678049927751.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_indemnity_bert", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_indemnity_bert|
...
```bash
   ...
   Indemnity      0.92   0.86      0.89       28
       Other      0.91   0.95      0.93       43
    accuracy         -      -      0.92       71
