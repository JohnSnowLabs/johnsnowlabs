...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/contextual_assertion_absent_en_6.2.2_3.4_1768168053296.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/contextual_assertion_absent_en_6.2.2_3.4_1768168053296.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
val flattener = new Flattener()
    .setInputCols("assertionAbsent")
    .setExplodeSelectedFields(Map("assertionAbsent" -> Array(
