---
layout: model
title: Legal Demand Registration Clause Binary Classifier
author: John Snow Labs
name: legclf_demand_registration_clause
date: 2022-12-07
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_demand_registration_clause_en_1.0.0_3.0_1670444564459.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_demand_registration_clause_en_1.0.0_3.0_1670444564459.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_demand_registration_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_demand_registration_clause|
...
demand-registration       1.00      0.96      0.98        28
