---
layout: model
title: Legal Successors Clause Binary Classifier (LEDGAR)
author: John Snow Labs
name: legclf_successors_bert
date: 2023-03-05
tags: [en, legal, classification, clauses, successors, licensed, tensorflow]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_successors_bert_en_1.0.0_3.0_1678049877265.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_successors_bert_en_1.0.0_3.0_1678049877265.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_successors_bert", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_successors_bert|
...
```bash
       ...
       Other      1.00   1.00       1.0       76
  Successors      1.00   1.00       1.0       55
    accuracy         -      -       1.0      131
   macro-avg      1.00   1.00       1.0      131
weighted-avg      1.00   1.00       1.0      131
```