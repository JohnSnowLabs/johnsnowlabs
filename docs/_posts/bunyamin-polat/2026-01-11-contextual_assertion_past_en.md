...
date: 2026-01-11
tags: [past, en, assertion, contextual, licensed, clinical]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/contextual_assertion_past_en_6.2.2_3.4_1768168070882.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/contextual_assertion_past_en_6.2.2_3.4_1768168070882.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
val flattener = new Flattener()
    .setInputCols("assertionPast")
    .setExplodeSelectedFields(Map("assertionPast" -> Array(
