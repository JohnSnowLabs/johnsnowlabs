---
layout: model
title: Legal Venues Clause Binary Classifier (LEDGAR)
author: John Snow Labs
name: legclf_venues_bert
date: 2023-03-05
tags: [en, legal, classification, clauses, venues, licensed, tensorflow]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_venues_bert_en_1.0.0_3.0_1678050565118.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_venues_bert_en_1.0.0_3.0_1678050565118.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_venues_bert", "en", "legal/models")\
