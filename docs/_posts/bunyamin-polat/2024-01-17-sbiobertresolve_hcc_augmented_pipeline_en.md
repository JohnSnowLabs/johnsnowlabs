...
name: sbiobertresolve_hcc_augmented_pipeline
date: 2024-01-17
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/sbiobertresolve_hcc_augmented_pipeline_en_5.2.1_3.0_1705485375842.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/sbiobertresolve_hcc_augmented_pipeline_en_5.2.1_3.0_1705485375842.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
ner_pipeline = PretrainedPipeline("sbiobertresolve_hcc_augmented_pipeline", "en", "clinical/models")
...
val ner_pipeline = PretrainedPipeline("sbiobertresolve_hcc_augmented_pipeline", "en", "clinical/models")
...
{:.table-model}
|---|---|
|Model Name:|sbiobertresolve_hcc_augmented_pipeline|
|Type:|pipeline|
