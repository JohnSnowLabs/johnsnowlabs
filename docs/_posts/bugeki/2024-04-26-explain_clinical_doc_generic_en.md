...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/explain_clinical_doc_generic_en_5.3.1_3.0_1714129722915.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/explain_clinical_doc_generic_en_5.3.1_3.0_1714129722915.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
|       3|          131|        132|          CT|     TEST|          135|        144| lung tumor|PROBLEM|    TeRP|       1.0|
+--------+-------------+-----------+------------+---------+-------------+-----------+-----------+-------+--------+----------+
