...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/re_oncology_test_result_en_5.4.0_3.0_1720014762052.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/re_oncology_test_result_en_5.4.0_3.0_1720014762052.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
re_model = RelationExtractionModel.pretrained("re_oncology_test_result", "en", "clinical/models") \
...
val re_model = RelationExtractionModel.pretrained("re_oncology_test_result", "en", "clinical/models")
...
{:.table-model}
|---|---|
|Model Name:|re_oncology_test_result|
|Type:|re|
