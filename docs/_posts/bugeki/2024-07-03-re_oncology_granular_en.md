...
re_model = RelationExtractionModel.pretrained("re_oncology_granular", "en", "clinical/models") \
...
val re_model = RelationExtractionModel.pretrained("re_oncology_granular", "en", "clinical/models")
