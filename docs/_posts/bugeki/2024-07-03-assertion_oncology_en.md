...
assertion = AssertionDLModel.pretrained("assertion_oncology", "en", "clinical/models") \
...
val clinical_assertion = AssertionDLModel.pretrained("assertion_oncology","en","clinical/models")
