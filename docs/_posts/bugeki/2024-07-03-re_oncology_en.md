...
re_model = RelationExtractionModel.pretrained("re_oncology", "en", "clinical/models") \
...
val re_model = RelationExtractionModel.pretrained("re_oncology", "en", "clinical/models")
