...
name: ip_matcher
date: 2026-09-07
tags: [en, clinical, licensed, ip, regexmatcher, matcher]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/ip_matcher_en_6.4.0_3.4_1788795135908.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/ip_matcher_en_6.4.0_3.4_1788795135908.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
