---
layout: model
title: Legal Remedies Clause Binary Classifier
author: John Snow Labs
name: legclf_remedies_clause
date: 2023-02-13
tags: [en, legal, classification, remedies, licensed, tensorflow]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_remedies_clause_en_1.0.0_3.0_1676303332118.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_remedies_clause_en_1.0.0_3.0_1676303332118.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_remedies_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_remedies_clause|
