---
layout: model
title: Legal Reimbursement Of Expenses Clause Binary Classifier
author: John Snow Labs
name: legclf_reimbursement_of_expenses_clause
date: 2023-01-29
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_reimbursement_of_expenses_clause_en_1.0.0_3.0_1675004913668.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_reimbursement_of_expenses_clause_en_1.0.0_3.0_1675004913668.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_reimbursement_of_expenses_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_reimbursement_of_expenses_clause|
...
```bash
                    ...
                    other       0.94      0.77      0.85        39
reimbursement-of-expenses       0.77      0.94      0.85        32
                 accuracy          -         -      0.85        71
