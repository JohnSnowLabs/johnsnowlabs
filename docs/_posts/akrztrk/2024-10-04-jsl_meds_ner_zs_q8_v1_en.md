---
layout: model
title: JJSL_MedS_NER (LLM - q8)
author: John Snow Labs
name: jsl_meds_ner_zs_q8_v1
date: 2024-10-04
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/jsl_meds_ner_zs_q8_v1_en_5.5.0_3.0_1728077563420.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/jsl_meds_ner_zs_q8_v1_en_5.5.0_3.0_1728077563420.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
medical_llm = MedicalLLM.pretrained("jsl_meds_ner_zs_q8_v1", "en", "clinical/models")\
...
val medical_llm = MedicalLLM.pretrained("jsl_meds_ner_zs_q8_v1", "en", "clinical/models")
    .setInputCols("document")
    .setOutputCol("completions")
    .setBatchSize(1)
    .setNPredict(100)
...
{:.table-model}
|---|---|
|Model Name:|jsl_meds_ner_zs_q8_v1|
