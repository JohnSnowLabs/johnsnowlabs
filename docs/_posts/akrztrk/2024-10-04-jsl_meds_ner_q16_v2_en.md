---
layout: model
title: JJSL_MedS_NER_v2 (LLM - q16)
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/jsl_meds_ner_q16_v2_en_5.5.0_3.0_1728061998680.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/jsl_meds_ner_q16_v2_en_5.5.0_3.0_1728061998680.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
medical_llm = MedicalLLM.pretrained("jsl_meds_ner_q16_v2", "en", "clinical/models")\
...
val medical_llm = MedicalLLM.pretrained("jsl_meds_ner_q16_v2", "en", "clinical/models")
    .setInputCols("document")
    .setOutputCol("completions")
    .setBatchSize(1)
    .setNPredict(100)
