...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/fewhot_assertion_i2b2_e5_base_v2_i2b2_en_5.3.3_3.0_1720012882231.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/fewhot_assertion_i2b2_e5_base_v2_i2b2_en_5.3.3_3.0_1720012882231.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
tokenizer = sparknlp.annotator.token.Tokenizer()\
...
val tokenizer = sparknlp.annotator.token.Tokenizer()
    .setInputCols("sentence")
    .setOutputCol("token")
...
|License:|Licensed|
|Edition:|Official|
|Input Labels:|[assertion_sentence]|
