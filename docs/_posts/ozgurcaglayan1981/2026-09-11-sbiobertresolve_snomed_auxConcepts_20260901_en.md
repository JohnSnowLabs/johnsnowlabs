---
layout: model
title: Sentence Entity Resolver for SNOMED CT (Auxiliary Concepts) (sbiobert_base_cased_mli_onnx embeddings)
author: John Snow Labs
name: sbiobertresolve_snomed_auxConcepts_20260901
date: 2026-09-11
tags: [en, snomed, resolver, licensed, clinical, auxconcepts, sbiobert]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/sbiobertresolve_snomed_auxConcepts_20260901_en_6.4.1_3.4_1789135144936.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/sbiobertresolve_snomed_auxConcepts_20260901_en_6.4.1_3.4_1789135144936.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
