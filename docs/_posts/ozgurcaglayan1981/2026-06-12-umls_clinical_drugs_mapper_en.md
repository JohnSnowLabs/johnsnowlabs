---
layout: model
title: Mapping Entities (Clinical Drug) with Corresponding UMLS CUI Codes
author: John Snow Labs
name: umls_clinical_drugs_mapper
date: 2026-06-12
tags: [en, chunk_mapper, licensed, clinical, umls, clinical_drug]
task: Chunk Mapping
language: en
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/umls_clinical_drugs_mapper_en_6.4.0_3.4_1781270614880.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/umls_clinical_drugs_mapper_en_6.4.0_3.4_1781270614880.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
