---
layout: model
title: Pipeline to Mapping Entities (Major Clinical Concepts) with Corresponding UMLS CUI Codes
author: John Snow Labs
name: umls_major_concepts_mapping
date: 2026-03-04
tags: [en, umls, major_conceptsmapping, licensed, clinical, chunk_mapper, pipeline]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/umls_major_concepts_mapping_en_6.3.0_3.4_1772649879812.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/umls_major_concepts_mapping_en_6.3.0_3.4_1772649879812.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
