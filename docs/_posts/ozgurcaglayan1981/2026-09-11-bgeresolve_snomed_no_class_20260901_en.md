---
layout: model
title: Sentence Entity Resolver for SNOMED CT (Miscellaneous (No Class) Concepts) (bge_base_en_v1_5_onnx embeddings)
author: John Snow Labs
name: bgeresolve_snomed_no_class_20260901
date: 2026-09-11
tags: [en, snomed, resolver, licensed, clinical, no_class, bge]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/bgeresolve_snomed_no_class_20260901_en_6.4.1_3.4_1789155451226.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/bgeresolve_snomed_no_class_20260901_en_6.4.1_3.4_1789155451226.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
resolver = SentenceEntityResolverModel.pretrained("bgeresolve_snomed_no_class_20260901","en","clinical/models")\
...
resolver = medical.SentenceEntityResolverModel.pretrained("bgeresolve_snomed_no_class_20260901","en","clinical/models")\
    .setInputCols(["bge_embeddings"])\
    .setOutputCol("snomed_code")\
    .setDistanceFunction("EUCLIDEAN")\
    .setThreshold(1000)
...
val resolver = SentenceEntityResolverModel
    .pretrained("bgeresolve_snomed_no_class_20260901", "en", "clinical/models")
...
|:---------------------------|:--------------------------|----------------:|:------------------------------------------------------|:------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------|
| gastroparesis              | Disease_Syndrome_Disorder |      1397402007 | gastroparesis due to and following surgical procedure | 1397402007:::1399444005:::1388584008:::1389031007:::1396785002:::138551000146107... | gastroparesis due to and following surgical procedure:::gastric burping:::gastri... |
| malignant gastroblastoma   | Oncological               |   2711000181102 | malignant gastroblastoma                              | 2711000181102:::112761000112106:::112711000112109:::127221002:::112851000112103:... | malignant gastroblastoma:::malignant neoplasm of stomach suspected:::malignant n... |
...
{:.table-model}
|---|---|
|Model Name:|bgeresolve_snomed_no_class_20260901|
