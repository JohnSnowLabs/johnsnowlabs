---
layout: model
title: Plate Number Contextual Parser Pipeline
author: John Snow Labs
name: plate_parser_pipeline
date: 2026-03-04
tags: [en, contextualparser, licensed, clinical, plate, pipeline]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/plate_parser_pipeline_en_6.3.0_3.4_1772588194875.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/plate_parser_pipeline_en_6.3.0_3.4_1772588194875.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
