...
date: 2026-03-04
tags: [en, mesh, umls, mapping, licensed, clinical, chunk_mapper, pipeline]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/mesh_umls_mapping_en_6.3.0_3.4_1772646828624.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/mesh_umls_mapping_en_6.3.0_3.4_1772646828624.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
