---
layout: model
title: Sentence Entity Resolver for SNOMED CT (Body Structures) (mpnet_embeddings_biolord_2023_c embeddings)
author: John Snow Labs
name: biolordresolve_snomed_bodyStructure_20260901
date: 2026-09-11
tags: [en, snomed, resolver, licensed, clinical, bodystructure, biolord]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/biolordresolve_snomed_bodyStructure_20260901_en_6.4.1_3.4_1789153806341.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/biolordresolve_snomed_bodyStructure_20260901_en_6.4.1_3.4_1789153806341.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
