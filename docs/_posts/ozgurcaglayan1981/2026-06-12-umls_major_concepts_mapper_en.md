...
date: 2026-06-12
tags: [en, chunk_mapper, licensed, clinical, umls, major_concepts]
task: Chunk Mapping
language: en
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/umls_major_concepts_mapper_en_6.4.0_3.4_1781272600304.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/umls_major_concepts_mapper_en_6.4.0_3.4_1781272600304.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
