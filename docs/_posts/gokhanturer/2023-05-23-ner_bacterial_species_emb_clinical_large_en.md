...
species_ner = MedicalNerModel.pretrained("embeddings_clinical_large", "en", "clinical/models") \
...
val anatomy_ner_model = MedicalNerModel.pretrained("ner_bacterial_species_emb_clinical_large", "en", "clinical/models")
    .setInputCols(Array("sentence", "token"))
