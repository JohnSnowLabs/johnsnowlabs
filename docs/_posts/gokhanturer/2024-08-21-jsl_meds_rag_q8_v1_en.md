...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/jsl_meds_rag_q8_v1_en_5.4.1_3.0_1720040078717.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/jsl_meds_rag_q8_v1_en_5.4.1_3.0_1720040078717.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
llm_loader_pretrained = LLMLoader(spark).pretrained("jsl_meds_rag_q8_v1", "en", "clinical/models")
...
val llmLoader = new LLMLoader().setSparkSession(spark).pretrained("jsl_meds_rag_q8_v1", "en", "clinical/models")
