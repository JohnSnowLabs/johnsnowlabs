...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/ner_profiling_deid_en_5.3.0_3.0_1711626844189.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/ner_profiling_deid_en_5.3.0_3.0_1711626844189.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
ner_profiling_pipeline = PretrainedPipeline("ner_profiling_deid", 'en', 'clinical/models')
...
val ner_profiling_pipeline = PretrainedPipeline("ner_profiling_deid", "en", "clinical/models")
