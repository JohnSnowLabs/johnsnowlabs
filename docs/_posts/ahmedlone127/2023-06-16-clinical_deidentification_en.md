...
`ACCOUNT`, `AGE`, `CITY`, `COUNTRY`, `DATE`, `DOCTOR`, `E-MAIL`, `HOSPITAL`, `ID`, `IDNUM`, `IPADDR`, `MEDICALRECORD`, `ORGANIZATION`, `PATIENT`, `PHONE`, `PLATE`, `PROFESSION`, `SEX`, `SSN`, `STREET`, `URL`, `USERNAME`, `ZIP`
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/clinical_deidentification_en_4.4.4_3.4_1686921164110.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/clinical_deidentification_en_4.4.4_3.4_1686921164110.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
