---
layout: model
title: Extract Clinical Problem Entities (low granularity) from Voice of the Patient Documents (embeddings_clinical_large)
author: John Snow Labs
name: ner_vop_problem_reduced_emb_clinical_large
date: 2023-06-07
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/ner_vop_problem_reduced_emb_clinical_large_en_4.4.3_3.0_1686148163011.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/ner_vop_problem_reduced_emb_clinical_large_en_4.4.3_3.0_1686148163011.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
