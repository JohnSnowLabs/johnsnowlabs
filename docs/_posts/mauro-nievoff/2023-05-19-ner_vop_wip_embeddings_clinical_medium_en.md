...
name: ner_vop_wip_embeddings_clinical_medium
date: 2023-05-19
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/ner_vop_wip_embeddings_clinical_medium_en_4.4.2_3.0_1684509750529.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/ner_vop_wip_embeddings_clinical_medium_en_4.4.2_3.0_1684509750529.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
ner = MedicalNerModel.pretrained("ner_vop_wip_embeddings_clinical_medium", "en", "clinical/models") \
...
val ner = MedicalNerModel.pretrained("ner_vop_wip_embeddings_clinical_medium", "en", "clinical/models")
...
{:.table-model}
|---|---|
|Model Name:|ner_vop_wip_embeddings_clinical_medium|
