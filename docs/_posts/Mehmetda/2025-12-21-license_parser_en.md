...
name: license_parser
date: 2025-12-21
tags: [en, contextualparser, licensed, clinical, license]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/license_parser_en_6.2.2_3.0_1766332625452.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/license_parser_en_6.2.2_3.0_1766332625452.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
license_contextual_parser = medical.ContextualParserModel.pretrained("license_parser","en","clinical/models")\
    .setInputCols(["sentence", "token"])\
    .setOutputCol("chunk_license")
