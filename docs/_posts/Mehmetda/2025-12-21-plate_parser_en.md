...
name: plate_parser
date: 2025-12-21
tags: [en, contextualparser, licensed, clinical, plate]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/plate_parser_en_6.2.2_3.0_1766314513055.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/plate_parser_en_6.2.2_3.0_1766314513055.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
plate_contextual_parser = medica.ContextualParserModel.pretrained("plate_parser","en","clinical/models")\
    .setInputCols(["sentence", "token"])\
    .setOutputCol("chunk_plate")
