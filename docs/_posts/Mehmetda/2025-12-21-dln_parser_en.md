...
name: dln_parser
date: 2025-12-21
tags: [en, contextualparser, licensed, clinical, dln]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/dln_parser_en_6.2.2_3.0_1766310671527.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/dln_parser_en_6.2.2_3.0_1766310671527.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
dln_contextual_parser = ContextualParserModel.load("/content/parser/dln_parser")\
...
dln_contextual_parser = medical.ContextualParserModel.pretrained("dln_parser","en","clinical/models")\
    .setInputCols(["sentence", "token"])\
    .setOutputCol("chunk_dln")
