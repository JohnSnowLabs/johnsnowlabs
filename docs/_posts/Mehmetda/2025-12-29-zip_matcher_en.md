...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/zip_matcher_en_6.2.2_3.4_1767004225393.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/zip_matcher_en_6.2.2_3.4_1767004225393.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
zip_contextual_parser = ContextualParserModel.pretrained("zip_matcher", "en", "clinical/models")\
...
zip_contextual_parser = medical.ContextualParserModel.pretrained("zip_matcher", "en", "clinical/models")\
    .setInputCols(["sentence", "token"])\
    .setOutputCol("chunk_zip")
...
val zip_cp.json_contextual_parser = ContextualParserModel.pretrained("zip_matcher", "en", "clinical/models")
