...
name: rxnorm_mapper
date: 2024-06-20
tags: [rxnorm, chunk_mapper, en, licensed, clinical]
task: Chunk Mapping
language: en
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/rxnorm_mapper_en_5.3.3_3.0_1718894648227.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/rxnorm_mapper_en_5.3.3_3.0_1718894648227.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
