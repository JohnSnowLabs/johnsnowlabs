...
date: 2024-02-23
tags: [resolver, medication, snomed, umls, rxnorm, ndc, ade, en, licensed, pipeline]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/medication_resolver_pipeline_en_5.2.1_3.2_1708683606385.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/medication_resolver_pipeline_en_5.2.1_3.2_1708683606385.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
