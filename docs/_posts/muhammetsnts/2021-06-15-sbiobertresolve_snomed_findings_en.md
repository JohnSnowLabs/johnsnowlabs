...
This model maps extracted medical entities to Snomed codes (CT version) using sentence embeddings.
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/sbiobertresolve_snomed_findings_en_3.1.0_3.0_1623770110268.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/sbiobertresolve_snomed_findings_en_3.1.0_3.0_1623770110268.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
