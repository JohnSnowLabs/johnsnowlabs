---
layout: model
title: Arabic Bert Embeddings (Base, Arabert Model, v2)
...
Pretrained Bert Embeddings model, uploaded to Hugging Face, adapted and imported into Spark NLP. `bert-base-arabertv2` is a Arabic model orginally trained by `aubmindlab`.

{:.btn-box}
<button class="button button-orange" disabled>Live Demo</button>
<button class="button button-orange" disabled>Open in Colab</button>
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/bert_embeddings_bert_base_arabertv2_ar_3.4.2_3.0_1649677188338.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_embeddings_bert_base_arabertv2_ar_3.4.2_3.0_1649677188338.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
embeddings = BertEmbeddings.pretrained("bert_embeddings_bert_base_arabertv2","ar") \
...
val embeddings = BertEmbeddings.pretrained("bert_embeddings_bert_base_arabertv2","ar") 
...
```python
import nlu
nlu.load("ar.embed.bert_base_arabertv2").predict("""أنا أحب شرارة NLP""")
```
...
{:.table-model}
|---|---|
|Model Name:|bert_embeddings_bert_base_arabertv2|
...
- [https://huggingface.co/aubmindlab/bert-base-arabertv2](https://huggingface.co/aubmindlab/bert-base-arabertv2)
...
- /aubmindlab/bert-base-arabertv2/resolve/main/(https://github.com/google-research/bert/blob/master/multilingual.md)
