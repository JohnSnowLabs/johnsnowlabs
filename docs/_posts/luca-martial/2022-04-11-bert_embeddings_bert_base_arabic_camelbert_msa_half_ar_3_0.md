---
layout: model
title: Arabic Bert Embeddings (Base, Trained on a half of the full MSA dataset)
...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_embeddings_bert_base_arabic_camelbert_msa_half_ar_3.4.2_3.0_1649678623023.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
- [https://huggingface.co/CAMeL-Lab/bert-base-arabic-camelbert-msa-half](https://huggingface.co/CAMeL-Lab/bert-base-arabic-camelbert-msa-half)
