...
{:.table-model}
|---|---|
|Model Name:|bert_embeddings_bert_large_arabertv02|
...
- /aubmindlab/bert-large-arabertv02/resolve/main/(https://github.com/google-research/bert/blob/master/multilingual.md)
