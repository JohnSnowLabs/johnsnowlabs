...
name: ner_docwise_benchmark_large_preann
date: 2025-11-14
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/ner_docwise_benchmark_large_preann_en_6.0.4_3.4_1763089642103.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/ner_docwise_benchmark_large_preann_en_6.0.4_3.4_1763089642103.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
ner_docwise = PretrainedPipeline("ner_docwise_benchmark_large_preann", "en", "clinical/models")
...
val ner_docwise = PretrainedPipeline("ner_docwise_benchmark_large_preann", "en", "clinical/models")
...
{:.table-model}
|---|---|
|Model Name:|ner_docwise_benchmark_large_preann|
|Type:|pipeline|
