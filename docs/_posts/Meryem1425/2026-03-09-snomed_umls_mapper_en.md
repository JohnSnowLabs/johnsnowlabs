...
date: 2026-03-09
tags: [licensed, en, snomed, umls, mapping]
task: Chunk Mapping
language: en
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/snomed_umls_mapper_en_6.3.0_3.4_1773095248910.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/snomed_umls_mapper_en_6.3.0_3.4_1773095248910.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
data = spark.createDataFrame([['perflexane'], ['fluids']]).toDF("text")
...
val data = Seq(('perflexane'), ('fluids')).toDF("text")
