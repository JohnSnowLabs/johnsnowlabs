...
name: clinical_deidentification_docwise_wip_v2
date: 2024-11-29
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/clinical_deidentification_docwise_wip_v2_en_5.5.1_3.2_1732875915816.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/clinical_deidentification_docwise_wip_v2_en_5.5.1_3.2_1732875915816.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
{:.table-model}
|---|---|
|Model Name:|clinical_deidentification_docwise_wip_v2|
|Type:|pipeline|
