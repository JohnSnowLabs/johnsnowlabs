---
layout: model
title: Legal Relationship of the parties Clause Binary Classifier
author: John Snow Labs
name: legclf_relationship_of_the_parties_clause
date: 2022-08-10
...
`other`, `relationship_of_the_parties`

{:.btn-box}
[Live Demo](https://demo.johnsnowlabs.com/finance/CLASSIFY_LEGAL_CLAUSES/){:.button.button-orange}
<button class="button button-orange" disabled>Open in Colab</button>
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_relationship_of_the_parties_clause_en_1.0.0_3.2_1660122908778.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_relationship_of_the_parties_clause_en_1.0.0_3.2_1660122908778.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
{:.table-model}
|---|---|
|Model Name:|legclf_relationship_of_the_parties_clause|
