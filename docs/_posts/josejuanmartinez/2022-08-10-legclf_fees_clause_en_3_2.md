---
layout: model
title: Legal Fees Clause Binary Classifier
author: John Snow Labs
name: legclf_fees_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_fees_clause_en_1.0.0_3.2_1660122434131.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_fees_clause_en_1.0.0_3.2_1660122434131.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_fees_clause", "en", "legal/models")\
...
```bash
       label  precision    recall  f1-score   support
        fees       0.95      0.94      0.94        81
       other       0.98      0.99      0.98       284
    accuracy          -         -      0.98       365
