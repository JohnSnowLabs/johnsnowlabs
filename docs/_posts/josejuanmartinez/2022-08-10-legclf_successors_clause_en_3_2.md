---
layout: model
title: Legal Successors Clause Binary Classifier
author: John Snow Labs
name: legclf_successors_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_successors_clause_en_1.0.0_3.2_1660124037330.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_successors_clause_en_1.0.0_3.2_1660124037330.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_successors_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_successors_clause|
...
```bash
       ...
       other       1.00      0.98      0.99       159
  successors       0.96      1.00      0.98        72
    accuracy          -         -      0.99       231
   macro-avg       0.98      0.99      0.99       231
