---
layout: model
title: Legal Agreements Clause Binary Classifier
author: John Snow Labs
name: legclf_agreements_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_agreements_clause_en_1.0.0_3.2_1660122097948.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_agreements_clause_en_1.0.0_3.2_1660122097948.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_agreements_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_agreements_clause|
...
```bash
  ...
  agreements       0.84      0.83      0.83       212
       other       0.94      0.94      0.94       618
    accuracy          -         -      0.92       830
