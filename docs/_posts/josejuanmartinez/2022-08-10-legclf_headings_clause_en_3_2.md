---
layout: model
title: Legal Headings Clause Binary Classifier
author: John Snow Labs
name: legclf_headings_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_headings_clause_en_1.0.0_3.2_1660123578960.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_headings_clause_en_1.0.0_3.2_1660123578960.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_headings_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_headings_clause|
...
```bash
    ...
    headings       0.95      0.97      0.96       131
       other       0.98      0.98      0.98       252
    accuracy          -         -      0.97       383
