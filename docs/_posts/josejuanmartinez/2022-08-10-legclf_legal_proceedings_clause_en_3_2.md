---
layout: model
title: Legal Legal proceedings Clause Binary Classifier
author: John Snow Labs
name: legclf_legal_proceedings_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_legal_proceedings_clause_en_1.0.0_3.2_1660122602093.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_legal_proceedings_clause_en_1.0.0_3.2_1660122602093.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_legal_proceedings_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_legal_proceedings_clause|
...
legal-proceedings       0.96      0.79      0.87        29
            other       0.95      0.99      0.97       106
         accuracy          -         -      0.95       135
        macro-avg       0.95      0.89      0.92       135
