---
layout: model
title: Legal Vesting Clause Binary Classifier
author: John Snow Labs
name: legclf_vesting_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_vesting_clause_en_1.0.0_3.2_1660124119544.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_vesting_clause_en_1.0.0_3.2_1660124119544.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_vesting_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_vesting_clause|
