...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_distributions_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_distributions_clause|
...
distributions       0.88      0.90      0.89        41
        other       0.93      0.92      0.92        60
     accuracy          -         -      0.91       101
