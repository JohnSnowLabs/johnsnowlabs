---
layout: model
title: Legal Reports Clause Binary Classifier
author: John Snow Labs
name: legclf_reports_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_reports_clause_en_1.0.0_3.2_1660123946698.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_reports_clause_en_1.0.0_3.2_1660123946698.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_reports_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_reports_clause|
...
```bash
       ...
       other       0.94      0.95      0.94        62
     reports       0.91      0.88      0.90        34
    accuracy          -         -      0.93        96
