---
layout: model
title: Legal Death Clause Binary Classifier
author: John Snow Labs
name: legclf_death_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_death_clause_en_1.0.0_3.2_1660122314869.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_death_clause_en_1.0.0_3.2_1660122314869.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_death_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_death_clause|
...
```bash
       ...
       death       0.98      0.95      0.96        43
       other       0.98      0.99      0.99       112
    accuracy          -         -      0.98       155
