---
layout: model
title: Legal Background Clause Binary Classifier
author: John Snow Labs
name: legclf_background_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_background_clause_en_1.0.0_3.2_1660123254032.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_background_clause_en_1.0.0_3.2_1660123254032.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_background_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_background_clause|
...
```bash
  ...
  background       0.73      0.92      0.81        26
       other       0.97      0.89      0.93        81
    accuracy          -         -      0.90       107
