---
layout: model
title: Legal Defaults Clause Binary Classifier
author: John Snow Labs
name: legclf_defaults_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_defaults_clause_en_1.0.0_3.2_1660123396601.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_defaults_clause_en_1.0.0_3.2_1660123396601.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_defaults_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_defaults_clause|
...
```bash
    ...
    defaults       0.93      0.90      0.91       173
       other       0.95      0.96      0.95       316
    accuracy          -         -      0.94       489
