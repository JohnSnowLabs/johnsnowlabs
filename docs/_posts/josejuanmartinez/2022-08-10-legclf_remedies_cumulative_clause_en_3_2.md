---
layout: model
title: Legal Remedies cumulative Clause Binary Classifier
author: John Snow Labs
name: legclf_remedies_cumulative_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_remedies_cumulative_clause_en_1.0.0_3.2_1660122931314.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_remedies_cumulative_clause_en_1.0.0_3.2_1660122931314.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_remedies_cumulative_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_remedies_cumulative_clause|
...
```bash
              ...
              other       1.00      0.96      0.98       114
remedies-cumulative       0.91      1.00      0.95        42
           accuracy          -         -      0.97       156
