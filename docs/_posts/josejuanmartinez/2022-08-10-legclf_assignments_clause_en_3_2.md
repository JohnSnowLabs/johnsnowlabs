---
layout: model
title: Legal Assignments Clause Binary Classifier
author: John Snow Labs
name: legclf_assignments_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_assignments_clause_en_1.0.0_3.2_1660123239154.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_assignments_clause_en_1.0.0_3.2_1660123239154.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_assignments_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_assignments_clause|
...
```bash
 ...
 assignments       0.91      0.93      0.92       103
       other       0.97      0.96      0.97       247
    accuracy          -         -      0.95       350
