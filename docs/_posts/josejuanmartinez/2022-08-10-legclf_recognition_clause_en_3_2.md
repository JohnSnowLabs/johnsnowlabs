---
layout: model
title: Legal Recognition Clause Binary Classifier
author: John Snow Labs
name: legclf_recognition_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_recognition_clause_en_1.0.0_3.2_1660123901737.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_recognition_clause_en_1.0.0_3.2_1660123901737.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_recognition_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_recognition_clause|
...
```bash
       ...
       other       0.92      0.99      0.95        70
 recognition       0.98      0.87      0.92        46
    accuracy          -         -      0.94       116
