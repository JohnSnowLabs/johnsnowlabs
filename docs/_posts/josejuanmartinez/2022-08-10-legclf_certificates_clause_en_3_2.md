---
layout: model
title: Legal Certificates Clause Binary Classifier
author: John Snow Labs
name: legclf_certificates_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_certificates_clause_en_1.0.0_3.2_1660122225478.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_certificates_clause_en_1.0.0_3.2_1660122225478.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_certificates_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_certificates_clause|
...
certificates       0.88      0.80      0.84        35
       other       0.94      0.96      0.95       105
    accuracy          -         -      0.92       140
