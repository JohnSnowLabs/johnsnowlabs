---
layout: model
title: Legal Benefits Clause Binary Classifier
author: John Snow Labs
name: legclf_benefits_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_benefits_clause_en_1.0.0_3.2_1660123261684.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_benefits_clause_en_1.0.0_3.2_1660123261684.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_benefits_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_benefits_clause|
