---
layout: model
title: Legal Compensation Clause Binary Classifier
author: John Snow Labs
name: legclf_compensation_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_compensation_clause_en_1.0.0_3.2_1660123321963.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_compensation_clause_en_1.0.0_3.2_1660123321963.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_compensation_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_compensation_clause|
...
compensation       0.94      0.88      0.91        34
       other       0.95      0.97      0.96        78
    accuracy          -         -      0.95       112
