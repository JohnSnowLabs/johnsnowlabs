---
layout: model
title: Legal Exercise of option Clause Binary Classifier
author: John Snow Labs
name: legclf_exercise_of_option_clause
date: 2022-08-10
...
`other`, `exercise-of-option`

{:.btn-box}
[Live Demo](https://demo.johnsnowlabs.com/finance/CLASSIFY_LEGAL_CLAUSES/){:.button.button-orange}
<button class="button button-orange" disabled>Open in Colab</button>
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_exercise_of_option_clause_en_1.0.0_3.2_1660122426759.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_exercise_of_option_clause_en_1.0.0_3.2_1660122426759.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_exercise_of_option_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_exercise_of_option_clause|
...
exercise-of-option       0.97      0.90      0.93        39
             other       0.96      0.99      0.97        91
          accuracy          -         -      0.96       130
