---
layout: model
title: Legal Voting Clause Binary Classifier
author: John Snow Labs
name: legclf_voting_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_voting_clause_en_1.0.0_3.2_1660123185915.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_voting_clause_en_1.0.0_3.2_1660123185915.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_voting_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_voting_clause|
...
```bash
       ...
       other       0.97      0.98      0.98       193
      voting       0.96      0.93      0.95        75
    accuracy          -         -      0.97       268
