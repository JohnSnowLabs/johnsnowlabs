---
layout: model
title: Legal Non discrimination Clause Binary Classifier
author: John Snow Labs
name: legclf_non_discrimination_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_non_discrimination_clause_en_1.0.0_3.2_1660122736812.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_non_discrimination_clause_en_1.0.0_3.2_1660122736812.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_non_discrimination_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_non_discrimination_clause|
