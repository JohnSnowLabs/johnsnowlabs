---
layout: model
title: Legal Covenants Clause Binary Classifier
author: John Snow Labs
name: legclf_covenants_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_covenants_clause_en_1.0.0_3.2_1660123381690.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_covenants_clause_en_1.0.0_3.2_1660123381690.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_covenants_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_covenants_clause|
...
```bash
   ...
   covenants       0.88      0.83      0.85       216
       other       0.93      0.95      0.94       488
    accuracy          -         -      0.91       704
   macro-avg       0.90      0.89      0.90       704
