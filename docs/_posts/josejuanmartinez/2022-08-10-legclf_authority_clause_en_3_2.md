---
layout: model
title: Legal Authority Clause Binary Classifier
author: John Snow Labs
name: legclf_authority_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_authority_clause_en_1.0.0_3.2_1660122135152.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_authority_clause_en_1.0.0_3.2_1660122135152.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_authority_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_authority_clause|
...
```bash
   ...
   authority       0.86      0.78      0.82        23
       other       0.95      0.97      0.96        99
    accuracy          -         -      0.93       122
