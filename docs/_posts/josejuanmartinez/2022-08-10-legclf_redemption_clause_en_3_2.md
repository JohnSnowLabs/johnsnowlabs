---
layout: model
title: Legal Redemption Clause Binary Classifier
author: John Snow Labs
name: legclf_redemption_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_redemption_clause_en_1.0.0_3.2_1660122886423.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_redemption_clause_en_1.0.0_3.2_1660122886423.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_redemption_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_redemption_clause|
...
```bash
       ...
       other       0.96      0.95      0.95       100
  redemption       0.85      0.88      0.87        33
    accuracy          -         -      0.93       133
