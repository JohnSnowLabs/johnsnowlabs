---
layout: model
title: Legal No conflicts Clause Binary Classifier
author: John Snow Labs
name: legclf_no_conflicts_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_no_conflicts_clause_en_1.0.0_3.2_1660122683948.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_no_conflicts_clause_en_1.0.0_3.2_1660122683948.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_no_conflicts_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_no_conflicts_clause|
...
no-conflicts       0.96      0.94      0.95        54
       other       0.98      0.99      0.98       153
    accuracy          -         -      0.98       207
