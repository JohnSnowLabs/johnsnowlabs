---
layout: model
title: Legal Parking Clause Binary Classifier
author: John Snow Labs
name: legclf_parking_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_parking_clause_en_1.0.0_3.2_1660123803547.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_parking_clause_en_1.0.0_3.2_1660123803547.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_parking_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_parking_clause|
...
```bash
       ...
       other       0.94      0.99      0.96        69
     parking       0.96      0.85      0.90        27
    accuracy          -         -      0.95        96
