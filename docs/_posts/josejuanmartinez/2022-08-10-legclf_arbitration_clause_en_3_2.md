---
layout: model
title: Legal Arbitration Clause Binary Classifier
author: John Snow Labs
name: legclf_arbitration_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_arbitration_clause_en_1.0.0_3.2_1660122127772.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_arbitration_clause_en_1.0.0_3.2_1660122127772.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_arbitration_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_arbitration_clause|
...
```bash
 ...
 arbitration       0.95      0.95      0.95        21
       other       0.99      0.99      0.99        68
    accuracy          -         -      0.98        89
