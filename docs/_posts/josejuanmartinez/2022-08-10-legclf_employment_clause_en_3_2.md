---
layout: model
title: Legal Employment Clause Binary Classifier
author: John Snow Labs
name: legclf_employment_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_employment_clause_en_1.0.0_3.2_1660123473742.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_employment_clause_en_1.0.0_3.2_1660123473742.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_employment_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_employment_clause|
...
```bash
  ...
  employment       0.91      0.89      0.90        35
       other       0.95      0.96      0.96        84
    accuracy          -         -      0.94       119
