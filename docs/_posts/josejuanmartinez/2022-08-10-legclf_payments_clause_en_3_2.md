---
layout: model
title: Legal Payments Clause Binary Classifier
author: John Snow Labs
name: legclf_payments_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_payments_clause_en_1.0.0_3.2_1660122833664.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_payments_clause_en_1.0.0_3.2_1660122833664.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_payments_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_payments_clause|
...
```bash
       ...
       other       0.94      0.97      0.95       284
    payments       0.91      0.84      0.87       105
    accuracy          -         -      0.93       389
