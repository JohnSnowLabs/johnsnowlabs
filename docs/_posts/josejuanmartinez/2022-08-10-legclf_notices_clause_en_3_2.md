---
layout: model
title: Legal Notices Clause Binary Classifier
author: John Snow Labs
name: legclf_notices_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_notices_clause_en_1.0.0_3.2_1660122758974.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_notices_clause_en_1.0.0_3.2_1660122758974.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_notices_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_notices_clause|
...
```bash
     ...
     notices       0.96      0.97      0.97       191
       other       0.99      0.99      0.99       529
    accuracy          -         -      0.98       720
