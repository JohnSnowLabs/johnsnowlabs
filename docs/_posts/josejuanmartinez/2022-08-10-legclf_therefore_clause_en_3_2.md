---
layout: model
title: Legal Therefore Clause Binary Classifier
author: John Snow Labs
name: legclf_therefore_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_therefore_clause_en_1.0.0_3.2_1660124082046.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_therefore_clause_en_1.0.0_3.2_1660124082046.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_therefore_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_therefore_clause|
...
```bash
       ...
       other       0.96      0.99      0.97        88
   therefore       0.98      0.92      0.95        48
    accuracy          -         -      0.96       136
