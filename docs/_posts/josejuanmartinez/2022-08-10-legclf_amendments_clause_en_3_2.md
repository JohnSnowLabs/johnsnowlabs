...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_amendments_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_amendments_clause|
...
```bash
  ...
  amendments       0.95      0.96      0.95       227
       other       0.99      0.98      0.98       673
    accuracy          -         -      0.98       900
