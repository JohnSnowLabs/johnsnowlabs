...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_licenses_clause_en_1.0.0_3.2_1660123683498.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_licenses_clause_en_1.0.0_3.2_1660123683498.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_licenses_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_licenses_clause|
...
```bash
    ...
    licenses       0.91      0.84      0.88        38
       other       0.92      0.96      0.94        71
    accuracy          -         -      0.92       109
