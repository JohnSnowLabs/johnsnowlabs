---
layout: model
title: Legal Conditions precedent Clause Binary Classifier (md)
author: John Snow Labs
name: legclf_conditions_precedent_md
date: 2023-01-11
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_conditions_precedent_md_en_1.0.0_3.0_1673460306136.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_conditions_precedent_md_en_1.0.0_3.0_1673460306136.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_conditions_precedent_md", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_conditions_precedent_md|
...
term-of-agreement       0.97      1.00      0.98        32
