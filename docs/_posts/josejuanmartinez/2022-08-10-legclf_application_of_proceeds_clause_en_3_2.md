---
layout: model
title: Legal Application of proceeds Clause Binary Classifier
author: John Snow Labs
name: legclf_application_of_proceeds_clause
date: 2022-08-10
...
`other`, `application-of-proceeds`

{:.btn-box}
[Live Demo](https://demo.johnsnowlabs.com/finance/CLASSIFY_LEGAL_CLAUSES/){:.button.button-orange}
<button class="button button-orange" disabled>Open in Colab</button>
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_application_of_proceeds_clause_en_1.0.0_3.2_1660122112997.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_application_of_proceeds_clause_en_1.0.0_3.2_1660122112997.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_application_of_proceeds_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_application_of_proceeds_clause|
...
application-of-proceeds       0.95      0.95      0.95        37
                  other       0.98      0.98      0.98       111
               accuracy          -         -      0.97       148
