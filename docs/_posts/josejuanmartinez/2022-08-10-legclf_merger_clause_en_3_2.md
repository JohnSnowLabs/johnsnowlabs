---
layout: model
title: Legal Merger Clause Binary Classifier
author: John Snow Labs
name: legclf_merger_clause
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_merger_clause_en_1.0.0_3.2_1660122654083.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_merger_clause_en_1.0.0_3.2_1660122654083.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_merger_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_merger_clause|
...
```bash
      ...
      merger       0.83      0.90      0.86        39
       other       0.96      0.94      0.95       109
    accuracy          -         -      0.93       148
