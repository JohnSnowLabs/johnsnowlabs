---
layout: model
title: Disease Named Entity Recognition Spanish (Base, ONNX)
author: John Snow Labs
name: roberta_disease_ner_es_onnx
date: 2026-01-04
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/roberta_disease_ner_es_onnx_es_6.2.0_3.4_1767539267242.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/roberta_disease_ner_es_onnx_es_6.2.0_3.4_1767539267242.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
tokenClassifier = RoBertaForTokenClassification \
    .pretrained("roberta_disease_ner_es_onnx", "en", "clinical/models") \
