---
layout: model
title: Emotional Stressor Classifier (BERT) ONNX
author: John Snow Labs
name: bert_sequence_classifier_stressor_onnx
date: 2025-09-12
tags: [stressor, public_health, en, licensed, sequence_classification, onnx]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/bert_sequence_classifier_stressor_onnx_en_6.1.1_3.0_1757691204536.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/bert_sequence_classifier_stressor_onnx_en_6.1.1_3.0_1757691204536.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
