...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/bert_disease_ner_it_onnx_it_6.2.0_3.4_1767536596875.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/bert_disease_ner_it_onnx_it_6.2.0_3.4_1767536596875.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
|text                  |entity |
+----------------------+-------+
|diabete mellito       |DISEASE|
|ipertensione arteriosa|DISEASE|
+----------------------+-------+
```
