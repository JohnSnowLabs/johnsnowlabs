---
layout: model
title: RCT Classifier (BioBERT) ONNX
author: John Snow Labs
name: bert_sequence_classifier_rct_biobert_onnx
date: 2025-09-12
tags: [licensed, en, rct, bert, sequence_classification, onnx]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/bert_sequence_classifier_rct_biobert_onnx_en_6.1.1_3.0_1757684506902.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/bert_sequence_classifier_rct_biobert_onnx_en_6.1.1_3.0_1757684506902.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
