...
sequence_classifier = MedicalBertForSequenceClassification.pretrained("bert_sequence_classifier_sdoh_environment_status_onnx", "en", "clinical/models")\
...
sequenceClassifier = medical.BertForSequenceClassification.pretrained("bert_sequence_classifier_sdoh_environment_status_onnx", "en", "clinical/models")\
    .setInputCols(["document","token"])\
...
val sequenceClassifier = MedicalBertForSequenceClassification.pretrained("bert_sequence_classifier_sdoh_environment_status_onnx", "en", "clinical/models")
