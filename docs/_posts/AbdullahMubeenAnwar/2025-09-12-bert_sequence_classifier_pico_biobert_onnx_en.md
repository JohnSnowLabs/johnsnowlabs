---
layout: model
title: PICO Classifier (BERT) ONNX
author: John Snow Labs
name: bert_sequence_classifier_pico_biobert_onnx
date: 2025-09-12
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/bert_sequence_classifier_pico_biobert_onnx_en_6.1.1_3.0_1757684451172.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/bert_sequence_classifier_pico_biobert_onnx_en_6.1.1_3.0_1757684451172.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
val tokenClassifier = MedicalBertForTokenClassifier
  .pretrained("bert_sequence_classifier_pico_biobert_onnx", "en", "clinical/models")
