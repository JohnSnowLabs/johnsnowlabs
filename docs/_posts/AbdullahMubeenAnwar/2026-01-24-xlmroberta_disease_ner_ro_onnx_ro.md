---
layout: model
title: Disease Named Entity Recognition Romanian (Base, ONNX)
author: John Snow Labs
name: xlmroberta_disease_ner_ro_onnx
date: 2026-01-24
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/xlmroberta_disease_ner_ro_onnx_ro_6.2.0_3.4_1769251144328.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/xlmroberta_disease_ner_ro_onnx_ro_6.2.0_3.4_1769251144328.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
