...
This model is a BERT based multi-label sequence classifier for fine-grained disease classification in chest radiology reports. It is designed to evaluate or analyze free-text radiology report snippets, structured report sections, or individual clinical utterances. This model is the **leaf-level** variant, predicting the most specific disease findings in the ontology (e.g., *Atelectasis*, *Pneumonia*, *Simple pleural effusion*).
