---
layout: model
title: Detect PHI for Deidentification (Subentity Augmented - Docwise) (ner_deid_docwise_subentity_augmented_v1)
author: John Snow Labs
name: ner_deid_docwise_subentity_augmented_v1
date: 2026-07-03
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/ner_deid_docwise_subentity_augmented_v1_en_6.4.1_3.0_1783081298959.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/ner_deid_docwise_subentity_augmented_v1_en_6.4.1_3.0_1783081298959.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
ner_model = MedicalNerModel.pretrained("ner_deid_docwise_subentity_augmented_v1", "en", "clinical/models")\
...
His SSN is 999-00-1234. Dr. Gregory House is the attending as physician.
"""]]).toDF("text")
...
ner_model = medical.NerModel.pretrained("ner_deid_docwise_subentity_augmented_v1", "en", "clinical/models")\
    .setInputCols(["sentence", "token", "embeddings"])\
    .setOutputCol("ner")
...
val ner_model = MedicalNerModel.pretrained("ner_deid_docwise_subentity_augmented_v1", "en", "clinical/models")
...
{:.table-model}
|---|---|
|Model Name:|ner_deid_docwise_subentity_augmented_v1|
