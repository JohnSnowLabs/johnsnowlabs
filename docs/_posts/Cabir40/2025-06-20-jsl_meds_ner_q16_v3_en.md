---
layout: model
title: JSL_MedS_NER (LLM - q16 - v3)
author: John Snow Labs
name: jsl_meds_ner_q16_v3
date: 2025-06-20
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/jsl_meds_ner_q16_v3_en_6.0.2_3.0_1750425271244.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/jsl_meds_ner_q16_v3_en_6.0.2_3.0_1750425271244.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
medical_llm = MedicalLLM.pretrained("jsl_meds_ner_q16_v3", "en", "clinical/models")\
...
val medical_llm = MedicalLLM.pretrained("jsl_meds_ner_q16_v3", "en", "clinical/models")
    .setInputCols("document")
    .setOutputCol("completions")
    .setBatchSize(1)
    .setNPredict(100)
...
{:.table-model}
|---|---|
|Model Name:|jsl_meds_ner_q16_v3|
