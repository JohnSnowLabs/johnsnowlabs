---
layout: model
title: JSL_MedS_VLM (vlm - 2B - q16 - v2)
author: John Snow Labs
name: jsl_meds_vlm_2b_q16_v2
date: 2025-08-04
tags: [en, licensed, clinical, medical, llm, vlm, ner, q16, llamacpp]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/jsl_meds_vlm_2b_q16_v2_en_6.1.0_3.0_1754311493565.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/jsl_meds_vlm_2b_q16_v2_en_6.1.0_3.0_1754311493565.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
medical_llm = MedicalLLM.pretrained("jsl_meds_vlm_2b_q16_v2", "en", "clinical/models")\
...
medical_llm = medical.AutoGGUFModel.pretrained("jsl_meds_vlm_2b_q16_v2", "en", "clinical/models")\
    .setInputCols("document")\
    .setOutputCol("completions")\
    .setBatchSize(1)\
    .setNPredict(100)\
...
val medical_llm = MedicalLLM.pretrained("jsl_meds_vlm_2b_q16_v2", "en", "clinical/models")
    .setInputCols("document")
    .setOutputCol("completions")
    .setBatchSize(1)
    .setNPredict(100)
...
{:.table-model}
|---|---|
|Model Name:|jsl_meds_vlm_2b_q16_v2|
