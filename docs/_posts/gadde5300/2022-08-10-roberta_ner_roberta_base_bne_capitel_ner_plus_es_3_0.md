...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/roberta_ner_roberta_base_bne_capitel_ner_plus_es_4.1.0_3.0_1660140447438.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/roberta_ner_roberta_base_bne_capitel_ner_plus_es_4.1.0_3.0_1660140447438.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
- [https://huggingface.co/BSC-TeMU/roberta-base-bne-capitel-ner-plus](https://huggingface.co/BSC-TeMU/roberta-base-bne-capitel-ner-plus)
