---
layout: model
title: Spanish RobertaForTokenClassification Cased model (from chizhikchi)
author: John Snow Labs
name: roberta_ner_Spanish_disease_finder
date: 2022-08-10
...
Pretrained RobertaForTokenClassification model, adapted from Hugging Face and curated to provide scalability and production-readiness using Spark NLP. `Spanish_disease_finder` is a Spanish model originally trained by `chizhikchi`.
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/roberta_ner_Spanish_disease_finder_es_4.1.0_3.0_1660130991774.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/roberta_ner_Spanish_disease_finder_es_4.1.0_3.0_1660130991774.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
