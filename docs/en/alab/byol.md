...
The _admin_ user can upload a Spark NLP license JSON file by visiting the License page. The license is generated by the John Snow Labs license server and is available on [license.johnsnowlabs.com](https://license.johnsnowlabs.com/).
