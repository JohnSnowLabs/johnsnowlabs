...
| CARDINAL | 	Numerals that do not fall under another type. Like **hundreds** of models are avaiable in John Snow Labs Python NLP
...
|John Snow Labs Python NLP 	[0.5597224831581116, -0.703249454498291, -1.08...,]|
...
|token|    stem|  
|----|------|
|John Snow Labs Python NLP | John Snow Labs Python NLP  
|can | can |  
|get | get |  
|you | you |  
|the | the |  
