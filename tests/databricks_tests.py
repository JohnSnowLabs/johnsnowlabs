...
# Test Function
def test_submit_func(): print("Test Function")
...
class DatabricksTestCase(unittest.TestCase):
    ...
    def test_create_fresh_cluster(self):
        jsl.install(json_license_path=sct.db_lic, databricks_host=sct.ckl_host, databricks_token=sct.ckl_token)
    ...
    def test_create_fresh_cluster_and_run_task(self):
        ...
        johnsnowlabs.databricks_submit(databricks_host=sct.ckl_host, databricks_token=sct.ckl_token,
    ...
    def test_submit_task_to_databricks(self):
        ...
        jsl.run_in_databricks(nlp_test,
                              ...
                              databricks_token=sct.ckl_token,
                              run_name='nlp_test')
        jsl.run_in_databricks(ocr_test,
                              databricks_cluster_id=cluster_id,
                              databricks_host=sct.ckl_host,
                              databricks_token=sct.ckl_token,
                              run_name='ocr_test')
        jsl.run_in_databricks(hc_test,
                              databricks_cluster_id=cluster_id,
                              databricks_host=sct.ckl_host,
                              databricks_token=sct.ckl_token,
                              run_name='hc_test')

        jsl.run_in_databricks(test_submit_func,
                              databricks_cluster_id=cluster_id,
                              databricks_host=sct.ckl_host,
                              databricks_token=sct.ckl_token,
        ...
        jsl.run_in_databricks(py_script,
                              databricks_cluster_id=cluster_id,
                              databricks_host=sct.ckl_host,
                              databricks_token=sct.ckl_token,
...
print(nlu.load('sentiment').predict('That was easy!'))
        ...
        jsl.run_in_databricks("print('noice')",
                              databricks_cluster_id=cluster_id,
                              databricks_host=sct.ckl_host,
                              databricks_token=sct.ckl_token,
                              run_name='Code String test 2')

        jsl.run_in_databricks(nlu_func,
                              databricks_cluster_id=cluster_id,
                              databricks_host=sct.ckl_host,
                              databricks_token=sct.ckl_token,
                              run_name='Function test')
